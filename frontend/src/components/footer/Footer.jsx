        ...
        <footer className="bg-white dark:bg-gray-800 pt-4 pb-8 xl:pt-8">
            <div className="container max-w-screen-lg xl:max-w-screen-xl mx-auto px-4 sm:px-6 md:px-8 text-gray-400 dark:text-gray-300">
                <div className="text-lg font-light pb-8 flex flex-wrap justify-center">
                    ...
                    <div className="w-1/2 md:w-1/3 lg:w-1/5">
                        <h2 className="mb-4 text-gray-500 dark:text-gray-200 text-md uppercase">
                            SUBSCRIBE
                        </h2>
                        <p className="text-gray-500 text-base mb-4">Get E-mail updates about our latest shop and special offers.</p>
                        <form>
                            <div className="relative">
                                <input type="text" className=" rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="Email" />
                            </div>
                            <button className="mt-5 flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-purple-600 rounded-lg shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-purple-200" type="submit">
                                Subscribe
                            </button>
                        </form>
                    </div>
