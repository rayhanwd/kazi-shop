    ...
    return (
        <form className="form-inline my-3 flex">
            <div className="relative">
                <input style={{width:'540px'}} type="text" id="simple-email" className="rounded-l-lg lg:w-7xl flex-1 appearance-none border border-gray-300 py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none" placeholder="Search your item" />
            </div>
