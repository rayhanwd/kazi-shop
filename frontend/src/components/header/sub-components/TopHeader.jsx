        ...
        <div className="bg-gray-100">
            <div className="container mx-auto">
                <div className="flex p-4 pt-2">
                    <div className="sm:w-1/1 md:w-1/2 lg:w-1/3 flex items-center">
                        <div className="flex items-center"><RiMailOpenLine /> <span className="ml-3 text-md font-medium">support.kazishop.bd.com</span></div>
                    </div>
                    <div className="sm:w-1/1 md:w-1/2 lg:w-1/3 flex items-center">
                        <div className="flex items-center mx-auto"><RiSmartphoneLine /><span className="ml-3 text-md font-medium">+(880)19275346</span></div>
                    </div>
                    <div className="sm:w-1/1 md:w-1/2 lg:w-1/3 flex items-center">
